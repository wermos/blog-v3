...
<Gallery
  groupCaption="GEMM benchmark plots."
  images={[
    {
      src: img1,
      alt: "placeholder",
...
<Gallery
  groupCaption="Matrix inversion benchmark plots. (Note that the $y$-axis is in log scale.)"
  images={[
    {
      src: img3,
      alt: "placeholder",
...
<Gallery
  groupCaption="Similarity transform (i.e. computing $ABA^\top$) benchmark plots."
  images={[
    {
      src: img5,
      alt: "placeholder",
...
<Gallery
  groupCaption="Free coordinates to bound coordinates benchmark plots."
  images={[
    {
      src: img7,
      alt: "placeholder",
...
<Gallery
  groupCaption="Bound coordinates to free coordinates benchmark plots."
  images={[
    {
      src: img9,
      alt: "placeholder",
