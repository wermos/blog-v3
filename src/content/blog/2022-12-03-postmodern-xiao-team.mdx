...
import classicXiaoTeam from '@/assets/images/genshin/team-portraits/classic-xiao-team.png'
import postmodernXiaoTeam from '@/assets/images/genshin/team-portraits/postmodern-xiao-team.png'

import Noblesse from '@/assets/images/genshin/artifacts/Royal_Flora.png'
import ToTM from '@/assets/images/genshin/artifacts/Flower_of_Accolades.png'
import VH from '@/assets/images/genshin/artifacts/Flowering_Life.png'
import husk from '@/assets/images/genshin/artifacts/Bloom_Times.png'

import cinnabarSpindle from '@/assets/images/genshin/weapons/Cinnabar_Spindle.png'
import TTDS from '@/assets/images/genshin/weapons/Thrilling_Tales_of_Dragon_Slayers.png'
...
<Image
  src={classicXiaoTeam}
  alt="Classic Xiao team comp with Jean, Zhongli, Xiao, and Albedo"
/>
...
<Image 
  src={postmodernXiaoTeam}
  alt="Postmodern Xiao team comp with Sucrose, Zhongli, Xiao, and Albedo"
/>
...
<Image src={TTDS}
  alt="Thrilling Tales of Dragon Slayers catalyst weapon"
  width={200}
  class="align-left"
/>
...
<Image src={ToTM}
  alt="The flower from the Tenacity of the Millelith artifact set"
  width={200}
  class="align-left"
/>
...
<Image src={VH}
  alt="The flower from the Vermillion Hereafter artifact set"
  width={200}
  class="align-left"
/>
...
<Image src={husk}
  alt="The flower from the Husk of Opulent Dreams artifact set"
  width={200}
  class="align-left"
/>
...
<Image src={cinnabarSpindle}
  alt="Cinnabar Spindle sword"
  width={200}
  class="align-left"
/>
...
![Clip of Zhongli's Burst](../../assets/gifs/genshin/zhongli.gif)
...
![Clip of Albedo's Burst](../../assets/gifs/genshin/albedo.gif)
...
<YouTube id="3JImpX29Qkw" title="Postmodern Xiao Rotation" />
